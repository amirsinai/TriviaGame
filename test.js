$(document).ready(function () {
  ...
  var quiz = [
    {
      id: 1,
      visible: true,
      title: "1. Are you taking this quiz for yourself or for a family/friend?",
      required: true,
      group_answers: false,
      answers: [
        {
    ...
    },
    {
      ...
      answers: [
        ...
        {
          id: "q4_a23",
          title: "Personality changes not otherwise mentioned in this list",
          group: 3,
        },
        {
          id: "q4_a24",
    ...
    $.each(this.answers, function (index, value) {
      ...
      if (quiz.group_answers == true) {
        $(
          ...
          "#quiz-item-" +
            questionIndex +
            " .question-answers .question-group-" +
            this.group
        );
      }
  ...
  $("body").on("click", "button.quiz-submit", function () {
    ...
    if (recommendedArticlesCount == 0) {
      $(
        "<div id='no-recommended-reading'><p><b>We could not recommend any reading based on your reported symptoms.</b></p></div>"
      ).insertAfter("#recommended-reading");
